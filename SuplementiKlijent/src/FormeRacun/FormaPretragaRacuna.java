 ...
 * @author necam
 */
public class FormaPretragaRacuna extends javax.swing.JDialog {

    public FormaPretragaRacuna(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga racuna");
        ModelTabeleRacun model = new ModelTabeleRacun();
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        Long param;
        ModelTabeleRacun mt = (ModelTabeleRacun) tblRacuni.getModel();
        try {
        param = Long.valueOf(txtPretraga.getText());
        mt.setParametar(param); 
        } catch(NumberFormatException nfx) {
            mt.setParametar(null);
        }
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            Racun r = ((ModelTabeleRacun) tblRacuni.getModel()).getSelectedRacun(row);
            new FormaDetaljiRacuna(this, true, r).setVisible(true);
        }
